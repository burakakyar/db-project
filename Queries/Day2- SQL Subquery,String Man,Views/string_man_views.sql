...
select concat(FIRST_NAME,' '||LAST_NAME) as "fullnamee"
from EMPLOYEES;
...
--VIEW
CREATE VIEW Emaillist_burak as select substr(first_name,0,1)||'.'||substr(last_name,0,1) as "initials",
first_name||' '||last_name as "full_name",lower(email||'@gmail.com') as "full_email"
from employees;

select "full_name"
from EMAILLIST_BURAK;

--to remove view
drop view EMAILLIST_BURAK;
